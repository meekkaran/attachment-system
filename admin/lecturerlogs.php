        ...
        <div class="sidebar">
            <ul id="menu_list">
                ...
                <a class="menu_items_link" href="lecturerlogs.php">
                    <li class="menu_items_list" style="background-color:orange;padding-left:16px">Lecturer logs</li>
                </a>
        ...
        <div class="main">
            ...
            <div classs="reports">
                <form action="" method="GET">
                    <div class="options">
                        <input type="text" name="lecturer_id" placeholder="Enter LecturerID" value="<?php if (isset($_GET['lecturer_id'])) {
                                                                                                        echo $_GET['lecturer_id'];
                                                                                                    } ?>" />
            ...
            <table border="1" cellpadding="0">
                ...
                if (!isset($_GET['search'])) {
                    $query = "SELECT * FROM lecturerlogs";
                    getData($query);
                } elseif (isset($_GET['search'])) {
                    $lecturer_id = $_GET['lecturer_id'];
                    $sql = "SELECT * FROM lecturerlogs WHERE lecturer_id='$lecturer_id'";
                    getData($sql);
