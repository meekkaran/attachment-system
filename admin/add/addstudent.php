...
if (isset($_POST['submit'])) {
    ...
    company_email,company_region, startingdate, password,created_at) 
            VALUES('$fullname','$admissionnumber', '$email','$phonenumber','$companyname','$companycontact','$companyaddress',
            '$companyemail','$companyregion','$startingdate', '$password',now())";
        ...
        <div class="main">
            ...
            <form method="post" action="">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="company_region" value="">
                </div>
                <div class="input-group">
